    ...
    <div className="space-y-8 p-4 h-full overflow-y-auto">
              ...
              <Select value={roleFilter} onValueChange={setRoleFilter}>
                ...
                <SelectContent>
                  <SelectItem value="all">
                    {t('characters:roles.all')}
                  </SelectItem>
                  <SelectItem value="protagonist">
                    {t('characters:roles.protagonist')}
                  </SelectItem>
                  <SelectItem value="supporting">
                    {t('characters:roles.supporting')}
                  </SelectItem>
                  <SelectItem value="antagonist">
                    {t('characters:roles.antagonist')}
                  </SelectItem>
                  <SelectItem value="marginal">
                    {t('characters:roles.marginal')}
                  </SelectItem>
                  <SelectItem value="unsorted">
                    {t('characters:roles.unsorted')}
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
        ...
        {loading ? (
          ...
          <Card>
            <CardContent className="text-center py-20 text-muted-foreground">
              ...
              <p className="mb-4">
                {t('characters:empty.description', { bookName: book.name })}
              </p>
              <Button onClick={() => setIsCreateDialogOpen(true)}>
                <Plus className="h-4 w-4 mr-2" />
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {t('characters:deleteDialog.title')}
            </AlertDialogTitle>
            <AlertDialogDescription>
              {t('characters:deleteDialog.description', {
                name: `${characterToDelete?.firstName} ${characterToDelete?.lastName}`,
              })}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
